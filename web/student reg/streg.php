...
<body>
    ...
    <div class="contain">
        <form action="" method="post">
            <table>
                ...
                <tr>
                    <td align="center"><input type="submit" name="sub"></td>
                    <td><button><a href='student.php'>Home</a></button></td>
                </tr>
            </table>
        </form>
    </div>
    ...
    if (isset($_POST["sub"])) {
        ...
        if ($con) {
            $query = "UPDATE students SET name='$name', roll_no='$Rnum',Email='$email',Phone='$phone',Gender='$gen' WHERE id='$ID'";
